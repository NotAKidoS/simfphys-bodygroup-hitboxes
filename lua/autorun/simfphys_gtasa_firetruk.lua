local V = {
	...
	Members = {
        ...
        OnSpawn = function(ent)
			...
			local hitboxes = {}
			hitboxes.bumperf = {min = Vector(170,50,-14), max = Vector(130,-50,-34), bdgroup = 1, gibmodel = "models/gtasa/vehicles/firetruk/bump_front_dam.mdl", giboffset = Vector(134.55,-44.34,-18.44), health=200 }
			hitboxes.dfdoor = {min = Vector(138,50,45), max = Vector(98,30,-31), bdgroup = 2, gibmodel = "models/gtasa/vehicles/firetruk/door_lf_dam.mdl", giboffset = Vector(134.55,44.33,9.49), health=100 }
			hitboxes.pfdoor = {max = Vector(138,-50,45), min = Vector(98,-30,-31), bdgroup = 3, gibmodel = "models/gtasa/vehicles/firetruk/door_rf_dam.mdl", giboffset = Vector(134.55,-44.33,9.49), health=100 }
			hitboxes.windowf = {min = Vector(133,44,42), max = Vector(153,-44,15), bdgroup = 4, health=6, glass=true, glasspos=Vector(142.4,0,28.89) }
			
			hitboxes.gastank = {min = Vector(-122,44,-15), max = Vector(-139,36,-25), explode=true }
			...
			if ( ProxyColor ) then
				local CarCols = {}
				CarCols[1] = {Color(132,4,16),Color(245,245,245),Color(245,245,245),Color(0,0,0),Color(245,245,245)}
...
local light_table = {
	...
	Headlamp_sprites = {
		{pos = Vector(157.01,27.87,-5.26),size = 100,material = "sprites/light_ignorez"},
		{pos = Vector(157.01,-27.87,-5.26),size = 100,material = "sprites/light_ignorez"},
	},
	...
	SubMaterials = {
		...
		on_lowbeam = {
			Base = {
				[10] = "models/gtasa/vehicles/share/vehiclelightson128"
			},
		},
	}
}
