local V = {
	...
	Members = {
        ...
        OnSpawn = function(ent)
			...
			local hitboxes = {}
			hitboxes.hood = {min = Vector(36.187,-32.844,4), max = Vector(94,32.844,11.006), bdgroup = 1, gibmodel = "models/gtasa/vehicles/admiral/bonnet_dam.mdl", giboffset = Vector(42,0,10), health=120 }
			...
			hitboxes.bumperf = {min = Vector(79.655,-38,-20), max = Vector(96,38,-4), bdgroup = 3, gibmodel = "models/gtasa/vehicles/admiral/bump_front_dam.mdl", giboffset = Vector(97,-34,-8), health=60 }
			...
			hitboxes.windowf = {min = Vector(38.901,34.251,9.725), max = Vector(10.353,-34.251,27.39), bdgroup = 9, health=6 }
